...
Categories of embedded elements in XML are defined by Multipurpose
Internet Mail Extensions (MIME) and related standards.
...
Optionally, a `<documentation>` element may be qualified by MIME type to
...
<html:p><html:b>Account mnemonic</html:b> as agreed between buy
and sell sides, e.g. broker and institution or investor/intermediary
and fund manager.</html:p>
		</fixr:documentation>
	</fixr:annotation>
</fixr:field>
```
...
```xml
<fixr:component category="Common" added="FIX.4.3" id="1011"
name="OrderQtyData" abbrName="OrdQty" scenario="base">
	<fixr:fieldRef added="FIX.4.3" id="38" scenario="base"
presence="optional"/>
	<fixr:fieldRef added="FIX.4.3" id="152" scenario="base"
presence="optional"/>
	<fixr:fieldRef added="FIX.4.3" id="516" scenario="base"
presence="optional"/>
...
```xml
<fixr:fieldRef id="11" added="FIX.2.7" updated="FIX.5.0SP2"
updatedEP="188">
